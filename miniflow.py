...
def train_SGD(network, training_data, epochs=1, learning_rate=1e-2):
    """
    ...
    Arguments:
        ...
        `network`: The connected layers of the network.
    ...
    # Will eventually be the weights and biases.
    trainables = []

    sorted_layers = topological_sort(feed_dict)

    # unzip the training data, create the feed_dict
